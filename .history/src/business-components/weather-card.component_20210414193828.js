...
const WeatherCard = ({ iconName, description, date, temperature, unit }) => {
  ...
  return (
    <div className='bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 from-yellow-400 via-red-500 to-pink-500 rounded-xl shadow-md w-10/12 md:w-40 lg:w-44 mx-auto'>
      <div>{dayOfWeek}</div>
