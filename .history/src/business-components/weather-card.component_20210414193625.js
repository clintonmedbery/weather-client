...
const WeatherCard = ({ iconName, description, date, temperature, unit }) => {
  ...
  return (
    <div className='from-blue-600 via-teal-500 to-purple-500 bg-gradient-to-r rounded-xl shadow-md overflow-hidden bg-blue-200 w-10/12 md:w-40 lg:w-44 mx-auto'>
      <div>{dayOfWeek}</div>
